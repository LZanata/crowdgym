...
if (isset($_GET['id'])) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        header("Location: http://localhost/Projeto_CrowdGym/gerente_planos.php?removido=1");
    } else {
        // Em caso de erro, redireciona com uma mensagem de erro
        header("Location: http://localhost/Projeto_CrowdGym/gerente_planos.php?removido=0");
        exit;
    }
